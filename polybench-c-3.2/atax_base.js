...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'atax_base.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'atax_base.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'atax_base.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "atax_base.html.mem" : null;
